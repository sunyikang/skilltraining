...
class Solution:
    def __init__(self):
        self.combination={}
        self.combination['IV'] = 4
        self.combination['IX'] = 9
        self.combination['XL'] = 40
        self.combination['XC'] = 90
        self.combination['CD'] = 400
        self.combination['CM'] = 900
        
    def kickout_combinations(self, str, num):
        return 1
    ...
    def romanToInt(self, s: str) -> int:
        ...
        #
        # dictionary combination["xx"] = number
        # original_string
        # final_count

        result = 0
        self.kickout_combinations(s, result)
        return 1